...
def main():
    ...
    data_sizes = [ 64_000, 128_000, 256_000, 512_000, 1_024_000, 2_056_000, 4_112_000 ]

    print("Generating all datasets")

    for data_size in data_sizes:
        for no_of_dimensions in dimensions:

            print(f"Generating {data_size} {no_of_dimensions}")
            distribution = 'gauss'
            no_of_queries = 1_000
            no_of_nns = 100
            no_of_ref_points = 0
            ...
            print( f"Finished generating {data_size} {no_of_dimensions}" )
